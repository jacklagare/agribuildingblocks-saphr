module.exports = {
    ...
    post: async (req,res,next) => {
        ...
        try{
            ...
            console.log("Check for existing suppliers...");

            let docRef = await db.collection("suppliers").select("name").where("name", "==",  req.body.name.trim());
            ...
            if(uniqueSupplier){
                ...
                if(transactionReceipt.status){
                        ...
                        let doc = db.collection('suppliers').add({
                            name: req.body.name,
